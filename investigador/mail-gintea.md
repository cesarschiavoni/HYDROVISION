...
Mi nombre es César Schiavoni, egresado de Ingeniería en Sistemas de UTN FRC (promoción 2012). Lucas Bergon, egresado de Ingeniería Electrónica de esta facultad y fundador de MBG Controls, es mi socio en el proyecto.
...
- Dedicación de ~4–5 horas/semana (~177 horas totales), modalidad mayormente remota
- Co-autoría garantizada en revista indexada Q1/Q2 — el costo de publicación (APC) ya está presupuestado en el proyecto

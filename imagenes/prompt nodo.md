...
* Función en el sistema: corrige CWSI por enfriamiento convectivo. Rampa 4-12 m/s: peso CWSI se reduce linealmente de 35% a 0%. A ≥12 m/s → HSI = 100% MDS.
...
**Etiquetar:** "Panel solar 6W policristalino — 200×170 mm, 6V nominal, orientado al norte, inclinación ~30°. Balance energético: genera 24-36 Wh/día en Cuyo vs. consumo 4,3 Wh/día → excedente +20-32 Wh/día."
...
* Estable hasta 60°C (crítico para interior de carcasa en verano de Cuyo)
...
donde **k = 0,6** (valor default para Malbec en Cuyo, calibrado contra Scholander). El factor k se puede recalibrar por varietal/región (rango típico: 0,4-0,9).
...
"Viñedo experimental Malbec — Colonia Caroya, Córdoba, Argentina — 1/3 ha (~3.333 m²), 10 filas × 136 plantas, espaldera VSP, ~700 m s.n.m. — 5 nodos en filas 2/4/6/8/10 — Regímenes hídricos: 100% / 75% / 50% / 25% / 0% ETc — Riego por goteo con controlador Rain Bird 10 zonas"

**8. Pequeño diagrama inset** (esquina inferior izquierda, ~15% del área de la imagen):
Vista aérea esquemática del viñedo completo mostrando las 10 filas paralelas, con las 5 que tienen nodo marcadas con un ícono circular rojo (filas 2, 4, 6, 8, 10) y las 5 filas buffer sin nodo (filas 1, 3, 5, 7, 9) en gris. Cada fila etiquetada con su porcentaje de riego: 100%, 100%, 100%, 75%, 100%, 50%, 100%, 25%, 100%, 0%. Título del inset: "Diseño experimental — 5 zonas hídricas".

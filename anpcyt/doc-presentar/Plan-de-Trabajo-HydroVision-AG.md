...
R10: Metodología de validación comercial preparada — template de entrevistas estructuradas (17 preguntas, 5 secciones: problema actual, demostración, disposición a pagar, usabilidad, cierre) y plan de ejecución listos. Contacto inicial con productores en campaña Bodega Las Cañitas (TRL 4). Las entrevistas formales (≥5 productores) y campañas de validación geográfica en Mendoza/San Juan se ejecutan en TRL 5.

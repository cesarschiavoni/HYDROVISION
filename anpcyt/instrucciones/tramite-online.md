...
- Validación en campo controlado: 5 filas experimentales Malbec 136m (680 vides) + 5 filas buffer intercaladas, 5 regímenes hídricos independientes (1 tratamiento uniforme por fila, solenoides Rain Bird), 5 nodos permanentes (uno por fila experimental, planta central), gimbal motorizado captura 7 ángulos cada 15 min en forma continua 24/7.
...
- Mes 3–4 (pre-campaña): conversión del viñedo experimental (riego canal → goteo diferencial, 5 filas experimentales con 1 régimen hídrico por fila + 5 filas buffer, solenoides Rain Bird). Ejecutado por Javier y Franco Schiavoni como contrapartida del equipo.
- Prototipo hardware integrado: MLX90640 + ESP32-S3 + SHT31 + anemómetro RS485 + extensómetro de tronco (strain gauge + ADS1231 + DS18B20) + GPS u-blox + SX1276 (EBYTE E32-900T20D) LoRa + panel solar. Autonomía objetivo ≥72 horas continuas.
- 5 nodos permanentes en 5 filas experimentales de Malbec (680 vides, filas 2/4/6/8/10) intercaladas con 5 filas buffer a 100% ETc (filas 1/3/5/7/9), 5 regímenes hídricos independientes (100% ETc → sin riego, 1 tratamiento uniforme por fila). Captura continua 24/7: 7 ángulos gimbal × 96 ciclos/día × 5 nodos. Dataset etiquetado: 20 pares directos Scholander (4 sesiones OED × 5 filas) + miles de frames con ψ_stem estimado por MDS dendrométrico.
...
| Instalación 5 solenoides + controlador Rain Bird | XX | XX | | | | | | | | | | |

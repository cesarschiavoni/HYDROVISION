...
2. **Confianza dinámica por viento con mitigación multinivel:** el nodo implementa 9 capas de defensa contra el artefacto de viento (orientación a sotavento, shelter anti-viento SHT31, tubo colimador IR, termopar foliar, buffer térmico con filtro de calma, rampa gradual firmware 4-18 m/s / 14-65 km/h, extendida por mitigaciones v2: Kalman IR↔termopar, Muller gbh, Hampel filter). El CWSI permanece útil hasta 18 m/s / 65 km/h (antes solo hasta 4 m/s). A partir de 18 m/s, el peso se transfiere automáticamente al 100% MDS dendrométrico. El sistema nunca da una alerta falsa por condición meteorológica adversa.
...
- Validación en campo controlado: 10 filas Malbec 136m (1.360 vides). Zona de calibración (filas 1–5): 5 regímenes hídricos independientes (F1=0% ETc, F2=15%, F3=40%, F4=65%, F5=100% ETc, solenoides Rain Bird), 5 nodos permanentes (uno por fila, planta central). Zona de producción (filas 6–10): todas 100% ETc, 5 nodos permanentes en modo comercial autónomo (pipeline completo CWSI→HSI→alerta→recomendación de riego). 10 nodos permanentes en total, gimbal motorizado captura 7 ángulos cada 15 min en forma continua 24/7.
...
No se ha recibido inversión privada externa a la fecha de presentación. El proyecto es financiado íntegramente por los socios fundadores (César Schiavoni 55% · Lucas Bergon 45%) mediante aporte en especie: (a) estación de trabajo IA — Intel Core i7-12700K + NVIDIA RTX 3070 8GB + 32GB RAM, valorización mercado secundario USD 2.500; (b) viñedo experimental Colonia Caroya 1/3 ha, acceso exclusivo con agua y electricidad y cooperación en protocolo de estrés hídrico, valorización USD 5.000; (c) horas de dedicación en especie — César Schiavoni Director IA 434 hs × USD 25/hs + Lucas Bergon COO/Hardware 116 hs × USD 40/hs, total USD 15.500; (d) material vegetal experimental — 1.360 vides Malbec establecidas, valorización USD 5.440; (e) herramientas de instalación y campo — kit propiedad de los fundadores cedido al proyecto (barrenador, taladro, cables, multímetro, etc.), valorización USD 400; (f) celular de campo — smartphone Xiaomi dedicado a monitoreo remoto del viñedo experimental, valorización USD 450; (g) equipamiento técnico — Lucas Bergon / MBG Controls (osciloscopio, analizador lógico, soldadores, fuentes reguladas, multímetro), valorización USD 710. Total aportes en especie: USD 30.000 (cumple exactamente el mínimo del 20% requerido). Pacto de socios con vesting de 4 años, cliff de 12 meses — en redacción. HydroVision AG SAS se constituirá en el Mes 1 del proyecto financiado.
...
- Mes 3–4 (pre-campaña): conversión del viñedo experimental (riego canal → goteo diferencial, 5 filas de calibración con 1 régimen hídrico por fila + 5 filas de producción a 100% ETc, solenoides Rain Bird). Ejecutado por Javier y Franco Schiavoni como contrapartida del equipo.
- Prototipo hardware integrado: MLX90640 + ESP32-S3 + SHT31 + anemómetro RS485 + extensómetro de tronco (strain gauge + ADS1231 + DS18B20) + GPS u-blox + SX1276 (EBYTE E32-900T20D) LoRa + panel solar. Autonomía objetivo ≥72 horas continuas.
- 10 nodos permanentes (5 calibración + 5 producción) en 10 filas de Malbec (1.360 vides). Zona de calibración (filas 1–5): 5 regímenes hídricos independientes (F1=0% ETc, F2=15%, F3=40%, F4=65%, F5=100% ETc, 1 tratamiento uniforme por fila). Zona de producción (filas 6–10): todas 100% ETc, nodos en modo comercial autónomo con pipeline completo CWSI→HSI→alerta→recomendación de riego. Captura continua 24/7: 7 ángulos gimbal × 96 ciclos/día × 10 nodos. Dataset etiquetado: 20 pares directos Scholander (4 sesiones OED × 5 filas calibración) + miles de frames con ψ_stem estimado por MDS dendrométrico.
...
| Javier Schiavoni | Técnico de campo principal — instalación sistema de riego diferencial (Mes 1–3), instalación y verificación extensómetro de tronco en 10 nodos (Mes 3), mantenimiento viñedo experimental, ejecución protocolo Scholander (4 sesiones OED Mes 4–9). ~227 hs totales con verificación D_max/D_min del extensómetro en cada sesión. Co-propietario del predio familiar. | Productor vitícola — Colonia Caroya, Córdoba. Residente en el sitio experimental. | ~6 hs/semana (Mes 1–9) — ~227 hs totales · USD 1.000/mes |
...
| Montaje 10 nodos en carcasa Hammond IP67 (Lucas/MBG) | | XX | XX | | | | | | | | | |
| Carcasa Hammond IP67 + sistema montaje estaca/bracket | | XX | XX | | | | | | | | | |
| Drip 1.450m + solenoides ×10 + controlador Rain Bird | XX | XX | | | | | | | | | | |
| Brackets acero ×64 + paneles emisividad ×64 | XX | XX | | | | | | | | | | |
| **INSTALACIÓN VIÑEDO EXPERIMENTAL (Técnico + Lucas)** | | | | | | | | | | | | |
| Tendido cinta drip 10 filas ×136m | XX | XX | | | | | | | | | | |
| Instalación 10 solenoides (1/fila) + Rain Bird | XX | XX | | | | | | | | | | |
| Prueba caudales 5 regímenes hídricos (0–100% ETc) | | XX | | | | | | | | | | |
| Instalación 64 brackets en postes espaldera | | XX | | | | | | | | | | |
| Túneles exclusión lluvia filas 1 y 2 (0% y 15% ETc) | | XX | | | | | | | | | | |
...
| **IA / MODELO PINN + VALIDACIÓN (César + Inv. Art. 32)** | | | | | | | | | | | | |

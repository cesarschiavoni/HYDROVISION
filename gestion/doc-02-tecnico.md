...
ESP32-S3 con deep sleep RTC DS3231: Consumo activo ~0.5W, deep sleep 8µA (~0.03mW). Con ciclo de captura cada 15 minutos (90s activo + 810s dormido), el consumo promedio es ~0.06W. Batería LiFePO4 6.000mAh a 3.2V = 19.2Wh. Autonomía sin sol: ~320 horas (>13 días). Panel 6W con 6h de sol efectivo/día genera 36Wh/día — balance energético positivo con amplio margen. El ESP32-S3 consume ~85% menos que RPi4 en el mismo ciclo de trabajo.

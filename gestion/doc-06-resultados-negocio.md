...
R10: Metodología de validación comercial preparada — template de entrevistas estructuradas (17 preguntas) y plan de ejecución listos. Las entrevistas formales con ≥5 productores (Las Cañitas, Mendoza, San Juan) y el informe de resultados son entregables de TRL 5. Input directo para el plan comercial TRL 5-6.

...
R10: Metodología de validación comercial preparada — template de entrevistas estructuradas (17 preguntas) y plan de ejecución listos. Contacto inicial con productores en campaña Bodega Las Cañitas (TRL 4). Las entrevistas formales con ≥5 productores en Mendoza y San Juan, y el informe de resultados, son entregables de TRL 5. Input directo para el plan comercial TRL 5-6.
...
Media
El proyecto concentra la validación primaria en el viñedo experimental de Colonia Caroya (5 filas de calibración + 5 filas de producción × 136m con drip diferencial, 10 nodos permanentes). La zona de producción (filas 6–10) genera datos de pipeline comercial autónomo validables contra el ground truth Scholander de la zona de calibración adyacente. En TRL 5 se amplía la validación geográfica a Mendoza y San Juan.

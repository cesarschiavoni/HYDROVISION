...
|------|-------------------|----:|
| 5 nodos prototipo Tier 1 | ESP32-S3 DevKit (MicroPython) + MLX90640 breakout integrado (Adafruit 4407) + SHT31 breakout + piranometro BPW34 + GPS u-blox + IMU ICM-42688-P + LoRa SX1276 + panel solar 6W + LiFePO4 6000mAh + carcasa Hammond IP67 200x150x100mm (sin PCB custom — arquitectura modular breakouts I2C/SPI) + anemometro RS485 + extensometro ADS1231 + pluviometro + PMS5003 + bomba Wet Ref + SSR + solenoide Rain Bird + repuestos criticos x2 juegos + prototipo testing destructivo + herramientas banco + proteccion ESD | 5.500 |
...
| [A]+[B] Infraestructura y equipamiento riego experimental | [A] Riego diferencial 10 filas: tanque australiano 20.000L + bomba centrifuga 0,5HP + caneria PE 63/50/32mm completa (136m + cross-headers) + cinta drip 1.450m + accesorios (USD 2.858). [B] Control experimental 5 zonas: solenoides Rain Bird 24VAC x5 + controlador 6 zonas + filtro + brackets x32 + paneles referencia x32 + tuneles exclusion lluvia + estacas x544 + cableado + drip reposicion + kit reparacion + senalizacion + malla antigranizo + canaleta UV (USD 2.500). Sistema imprescindible para los 5 regimenes hidricos independientes del protocolo experimental. | 5.358 |
| **Subtotal hardware** | | **17.347** |
...
| Javier Schiavoni | Tecnico de campo / Base+riego + Protocolo Scholander | ~208 hs totales (base tanque + riego + campo + Scholander 4 sesiones OED) | Mes 1-9 | 9.000 |
...
| Imprevistos y contingencias (~16,1%) | Reposicion componentes campo + variaciones importacion/tipo cambio + sesiones Scholander adicionales + reposicion drip/solenoides + contingencias operativas. Buffer justificado: hardware importado expuesto 12 meses en campo (lluvia, fumigaciones, granizo), protocolo Scholander sujeto a reprogramacion por condiciones climaticas, tipo de cambio volatil en Argentina. | 19.353 |
| **Subtotal operativos** | | **34.953** |
...
| Subtotal | USD | % ANR |
|----------|----:|------:|
| Hardware y equipamiento | 17.347 | 14,5% |
| Honorarios equipo | 64.800 | 54,0% |
| Cloud y licencias | 2.900 | 2,4% |
| Operativos y servicios | 34.953 | 29,1% |
...
| b) Infraestructura | [A]+[B] Riego experimental completo | 5.358 | 4,5% | <= 15% OK |
...
| e) Bienes capital | Hardware + gateway + conectividad + instrumentos | 11.989 | 10,0% | <= 30% OK |
...
**5 nodos prototipo Tier 1 (USD 5.500)**
Componentes x5 unidades: ESP32-S3 DevKit off-the-shelf (USD 60) · MLX90640 breakout integrado Adafruit 4407 (USD 275) · SHT31 breakout + piranometro BPW34 (USD 200) · GPS u-blox NEO-6M (USD 100) · ICM-42688-P IMU SPI (USD 50) · SX1276 LoRa (USD 75) · Panel solar 6W + regulador + LiFePO4 6000mAh (USD 375) · Carcasa Hammond IP67 200x150x100mm + pasacables M16 (USD 125) · Watchdog TPL5010 (USD 20) · Cables I2C Stemma QT/Qwiic + dupont + misc (USD 250) · Sistema montaje estaca+bracket+M12 (USD 225) · Proteccion ventana optica (USD 90) · Anemometro RS485 copa (USD 125) · Extensometro tronco: strain gauge + ADS1231 + DS18B20 + abrazadera (USD 150) · Bomba peristaltica Wet Ref (USD 80) · SSR + solenoide Rain Bird (USD 175) · Pluviometro balancin (USD 75) · PMS5003 particulas (USD 100) · Repuestos criticos x2 juegos (USD 550) · Prototipo testing destructivo y validacion termica (USD 450) · Herramientas banco: soldador estacion, flux, cables prueba (USD 300) · Proteccion ESD (USD 150). Total BOM x5: USD 5.500. Nota: eliminacion de PCB custom 4-layer (−USD 600) compensa mayor costo de breakouts MLX90640 y DevKit. Arquitectura modular TRL4.
...
**[A]+[B] Infraestructura y equipamiento riego experimental (USD 5.358 — ANR, Art. 21b)**
[A] Riego diferencial 10 filas (USD 2.858 — financiado con ANR): Tanque australiano 20.000L (USD 800) · Bomba centrifuga autocebante 0,5HP (USD 150) · Caneria PE 63mm suministro 15m (USD 68) · Caneria PE 63mm header principal 136m (USD 612) · Caneria PE 50mm cross-headers 5 zonas x 27m (USD 473) · Caneria PE 32mm conexiones 80m (USD 160) · Cinta goteo 16mm emisor 1m 1,5L/h x 1.450m (USD 435) · Accesorios (USD 160). Justificacion: infraestructura experimental imprescindible para crear los 5 regimenes hidricos independientes — eje central del protocolo TRL 3-4.
[B] Control experimental 5 zonas (USD 2.500 — ANR): Solenoides Rain Bird 24VAC x5 (USD 175) · Controlador Rain Bird 6 zonas + trafo 24V (USD 160) · Filtro malla 2" + regulador presion (USD 120) · Brackets acero inox x32 (USD 320) · Paneles referencia emisividad e=0.98 x32 (USD 128) · Tuneles exclusion lluvia 2 filas x 27m (USD 220) · Estacas numeradas x544 (USD 109) · Kit cableado campo (USD 91) · Cinta drip reposicion + accesorios (USD 177) · Kit reparacion solenoides (USD 150) · Senalizacion zonas (USD 80) · Malla antigranizo nodos (USD 370) · Canaleta portacables UV (USD 132).

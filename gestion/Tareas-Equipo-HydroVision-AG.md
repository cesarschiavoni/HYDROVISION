...
| # | Tarea | Período |
|---|-------|---------|
| 11 | Instalación física de los **5 nodos** en el viñedo experimental (1 por zona hídrica, junto a Javier Schiavoni). **Posición dentro de la zona: planta central (~14m desde el inicio de la zona de 27m, espaciado 1m entre plantas)**. Evitar las 3 plantas más cercanas a cada frontera de zona — en esos extremos el estrés hídrico es un gradiente entre tratamientos y el píxel Sentinel-2 mezcla zonas. | Mes 3–4 |
...
| 1 | Instalación completa infraestructura de riego: colocación del tanque sobre la losa, excavación zanjas para cañería PE 136m + cross-headers, tendido 1.450m cinta drip, instalación eléctrica 70m, operación tractor, conexión solenoides Rain Bird, pruebas hidráulicas | Mes 1–2 · 80h | Infraestructura base: sin riego por zona no hay protocolo de 5 regímenes hídricos |
...
| 3 | Instalación del extensómetro de tronco en 5 plantas de referencia: abrazadera aluminio anodizado, cara norte, 30 cm altura, verificación strain gauge. **La planta de referencia debe ser la misma planta central donde se instala el nodo** (planta ~14 desde el inicio de la zona de 27m, ≥3 plantas alejada de cada frontera de zona). Una planta de borde mediría el tratamiento incorrecto. | Mes 3 · 45 min/nodo × 5 = 4h | El extensómetro mide MDS 24/7 — es la señal de tronco que calibra la cámara y valida el modelo |

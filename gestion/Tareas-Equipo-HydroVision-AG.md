...
| 15 | **Campañas externas** (Bodega Las Cañitas, Mendoza, San Juan) — **TRL 5+**. En TRL 4 toda la validación es en Colonia Caroya | TRL 5+ |
...
| 15 | **Campañas externas** (Las Cañitas, Mendoza, San Juan) — **TRL 5+**. En TRL 4 toda la validación HW es en Colonia Caroya | TRL 5+ |
...
## Gabriel Campana — Asesor Vitivinícola / Validación Varietal (TRL 5+)
**Bodega:** Estancia Las Cañitas, Colonia Caroya
**Rol:** advisor en equity — sin costo para presupuesto ANPCyT
**Dedicación:** TRL 5+ (validación varietal y go-to-market post-TRL 4)

| # | Tarea | Período | Detalle |
|---|-------|---------|---------|
| 1 | **Validación de campo en Bodega Las Cañitas** con al menos 2 variedades distintas a Malbec | TRL 5+ | Provee acceso al viñedo + variedades + datos de riego existentes |
| 2 | Feedback sobre usabilidad del sistema desde perspectiva de productor profesional | TRL 5+ | Input para R10 (entrevistas formales validación comercial) |
| 3 | Caso de uso ancla para go-to-market TRL 5 — primera instalación comercial verificada | TRL 5+ | Aval de productor para presentación a inversores seed |
...
>
> **Contrapartida (USD 30.000):** César (~USD 24.240): estación IA USD 2.500 + viñedo experimental USD 5.000 + horas especie César USD 10.850 (434hs × USD 25/hs) + vides USD 5.440 + celular USD 450. Lucas (~USD 5.760): horas especie Lucas USD 4.650 (116hs × USD 40/hs) + herramientas campo USD 400 + equipamiento electrónico MBG Controls USD 710. Total: USD 30.000.
